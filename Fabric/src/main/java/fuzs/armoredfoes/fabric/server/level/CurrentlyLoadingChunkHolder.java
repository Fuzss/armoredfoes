package fuzs.armoredfoes.fabric.server.level;
...
public interface CurrentlyLoadingChunkHolder {
    ...
    void armoredfoes$setCurrentlyLoadingChunk(@Nullable LevelChunk levelChunk);

    @Nullable LevelChunk armoredfoes$getCurrentlyLoadingChunk();
}
